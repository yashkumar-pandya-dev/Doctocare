	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.php"><h2> Doctocare | Patient Login</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							...
							<div class="form-group form-actions">
								<span class="input-icon">
									<input type="password" class="form-control password" id="input" name="password" placeholder="Password">
									<input type="checkbox" onclick="function1()">Show Password
					...
					<div class="copyright">
						</span><span class="text-bold text-uppercase">Doctor Appointment System</span>.
					</div>
