...
<?php
include_once('Doctocare/include/config.php');
    ...
    <body>
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;margin-right:30px">Doctocare
                       <a data-toggle="collapse" data-target="#menu" href="#menu" ><i class="fas d-block d-md-none small-menu fa-bars"></i></a>
                    </div>
                    <div id="menu" class="col-lg-9 col-md-10 d-none d-md-block nav-item"><center>
                        <ul>
                            <li><a href="#">Home</a></li>
                            ...
                            <li><a class="btn btn-success" href="Doctocare/user-login.php" style="transform:translate(52rem,-60px); ">Book an Appointment</a></li>
                        </ul></center>
                    </div>
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Doctor Appointment System</h5>
  ...
  <!--  ************************* Logins ************************** -->
                ...
                <div class="row no-margin">
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                <h6>Patient Login</h6>
                                <a href="Doctocare/user-login.php" target="_blank">
                    ...
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                <h6>Doctors login</h6>
                                <a href="Doctocare/doctor" target="_blank">
                                    <button class="btn btn-success btn-sm">Click Here</button>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                ...
                                <a href="Doctocare/admin" target="_blank">
                                    <button class="btn btn-success btn-sm">Click Here</button>
                                </a>
                            </div>
                        </div>
    ...
    <section class="doctors" id="doctors">
        ...
        <div class="box-container">
          ...
          <div class="box">
            <img src="assets/images/doctors/ortho.jpeg">
            <h3>Dr. Narender Kumar Magu</h3>
            <span>MS - Orthopaedics, MBBS Orthopedist, Joint Replacement Surgeon, 35 years of experience
            </span>
            <div class="share">
            ...
            <div class="box b1">
              <img src="assets/images/doctors/ortho1.jpeg">
              <h3>Dr. Yatinder Kharbanda</h3>
              <span>Orthopaedic and Joint Replacement Surgeon 
                Senior Consultant , MBBS, D.Ortho, MS, DNB, MCh, 33 years of experience</span>
              <div class="share">
                <a href="#" class="fab fa-facebook-f"></a>
                <a href="#" class="fab fa-instagram"></a>
              </div>
            ...
            <div class="box b1">
              <img src="assets/images/doctors/cardi.jpeg">
              <h3>Dr. Vivek Jawali</h3>
              <span>Cardiac Surgeon 
                Chairman , DNB, MCh, MS, MBBS,40 years of experience</span>
              <div class="share">
                <a href="#" class="fab fa-facebook-f"></a>
                <a href="#" class="fab fa-instagram"></a>
              </div>
            ...
            <div class="box">
                <img src="assets/images/doctors/cardi1.jpeg">
                <h3>Dr. Ajay Kaul</h3>
                <span>Cardiac Surgeon 
                    Chairman , MBBS, MS, MCh, Fellowship, 38 years of experience
                </span>
                <div class="share">
                  <a href="#" class="fab fa-facebook-f"></a>
                  <a href="#" class="fab fa-instagram"></a>
            ...
            <div class="box b1">
                <img src="assets/images/doctors/nuero.jpeg">
                <h3>Dr. (Col) Joy Dev Mukherji</h3>
                <span>Principal Director and Head - Neurology Neurosciences, Neurology</span>
                <div class="share">
                  <a href="#" class="fab fa-facebook-f"></a>
                  <a href="#" class="fab fa-instagram"></a>
                </div>
            ...
            <div class="box">
                <img src="assets/images/doctors/nuero1.jpeg">
                <h3>Dr. Atul Prasad</h3>
                <span>Principal Director
            ...
            <div class="box b1">
                <img src="assets/images/doctors/onco.jpeg">
                <h3>Dr. Prasad E</h3>
                <span>Medical Oncologist 
                    Consultant , MBBS, Diploma, MD, DM, 16 years of experience</span>
                <div class="share">
                  <a href="#" class="fab fa-facebook-f"></a>
                  <a href="#" class="fab fa-instagram"></a>
                </div>
            ...
            <div class="box">
                <img src="assets/images/doctors/onco1.jpeg">
                <h3>  Dr. Rajesh Mistry</h3>
                <span>Surgical Oncologist 
                    Director , MBBS, MBBS, MS, 26 years of experience</span>
                <div class="share">
                  <a href="#" class="fab fa-facebook-f"></a>
                  <a href="#" class="fab fa-instagram"></a>
                </div>
    ...
    <section id="about_us" class="about-us">
        <div class="row no-margin">
            ...
            <div class="col-sm-6 abut-yoiu">
                ...
                <h3>A doctor appointment booking system is an online system that allows patients to easily book their appointment at a particular clinic related to their health issue. 
...
And if your clinic or doctor website has a doctor appointment booking system, then you can take a lot of leverage from it.</h3>
                <?php
